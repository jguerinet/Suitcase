 ...
 * @since 7.0.0
 */
open class LongSetting(settings: Settings, key: String, defaultValue: Long) :
    BaseSetting<Long>(settings, key, defaultValue) {
    ...
    override fun asFlow(): Flow<Long> = observableSettings.getLongFlow(key, defaultValue)
}
